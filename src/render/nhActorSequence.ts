...
export interface NhResolvedActorSequence {
  readonly sequenceName: RuntimeSequenceName;
  readonly playbackMode: NhSequencePlaybackMode;
...
export type NhActorSequenceDefinitionStore = ReadonlyMap<number, RuntimeSequenceName>;

const defaultActorSequenceDefinitions: NhActorSequenceDefinitionStore = new Map<number, RuntimeSequenceName>([
  [808, "idle"],
  [823, "turn"],
  [813, "wand_ready"],
  [1209, "wand_turn"],
  ...
  [1661, "whip_run"],
  [1658, "whip_attack"],
  [386, "sword_stab_attack"],
  [390, "sword_slash_attack"],
  [1665, "gmaul_attack"],
  [1667, "gmaul_special"],
  [440, "halberd_attack"],
  [809, "vesta_longsword_ready"],
  [7053, "godsword_ready"],
  [7044, "godsword_turn"],
  [7052, "godsword_walk"],
...
export function createNhActorSequenceDefinitionStore(source: unknown): NhActorSequenceDefinitionStore {
...
export function nhRuntimeSequenceNameForId(
  sequenceId: number | undefined,
  definitions: NhActorSequenceDefinitionStore = defaultActorSequenceDefinitions
): RuntimeSequenceName | undefined {
  return sequenceId === undefined ? undefined : definitions.get(sequenceId);
}

export function resolveNhActorSequence(
  animations: VisibleAnimationIds,
  definitions: NhActorSequenceDefinitionStore = defaultActorSequenceDefinitions
): NhResolvedActorSequence {
  const poseSequenceName = nhRuntimeSequenceNameForId(animations.pose, definitions);
  const movementSequenceName = nhRuntimeSequenceNameForId(animations.movement, definitions);
  const actionSequenceName = nhRuntimeSequenceNameForId(animations.action, definitions);
...
function runtimeSequenceNameField(value: unknown): RuntimeSequenceName | undefined {
  return value === "idle" ||
    ...
    value === "gmaul_attack" ||
    value === "gmaul_special" ||
    value === "halberd_attack" ||
    value === "vesta_longsword_ready" ||
    value === "sword_stab_attack" ||
    value === "sword_slash_attack" ||
