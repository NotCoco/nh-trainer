...
export interface NhDecodedPlayerAppearancePacket {
  ...
  readonly sequences: NhDecodedPlayerSequences;
...
export function decodeNhPlayerAppearancePacket(
  bytes: ArrayLike<number>,
  options: NhPlayerAppearancePacketDecodeOptions = {}
): NhDecodedPlayerAppearancePacket {
...
export function nhRuntimeAppearanceFromDecodedPacket(
  packet: Pick<NhDecodedPlayerAppearancePacket, "itemIds" | "bodyColors" | "equipmentSlots" | "team">
...
function resolveItemTeam(itemId: number, options: NhPlayerAppearancePacketDecodeOptions): number {
