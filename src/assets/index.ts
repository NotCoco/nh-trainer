...
export const assetCatalog: readonly AssetRecord[] = [
  ...
  },
  {
    ...
    requiredArtifacts: [
      ...
      "fixtures/render/spotanims/onyx_bolt_proc.glb",
  ...
  {
    id: "runtime-game-sounds",
    label: "Runtime game sound effects",
    source: "nh-cache",
    evidenceStatus: "verified",
    sourceAnchorIds: [
      "server-targetspell-contract",
    ...
    requiredArtifacts: [
      "fixtures/render/sounds/sound-effects.json",
      "fixtures/render/sounds/sound-102.wav",
      "fixtures/render/sounds/sound-104.wav",
      "fixtures/render/sounds/sound-106.wav",
      "fixtures/render/sounds/sound-168.wav",
      "fixtures/render/sounds/sound-169.wav",
      "fixtures/render/sounds/sound-171.wav",
      "fixtures/render/sounds/sound-227.wav",
      "fixtures/render/sounds/sound-1982.wav",
      "fixtures/render/sounds/sound-2238.wav",
      "fixtures/render/sounds/sound-2242.wav",
      "fixtures/render/sounds/sound-2244.wav",
      "fixtures/render/sounds/sound-2246.wav",
      "fixtures/render/sounds/sound-2266.wav",
      "fixtures/render/sounds/sound-2393.wav",
      "fixtures/render/sounds/sound-2401.wav",
      "fixtures/render/sounds/sound-2500.wav",
      "fixtures/render/sounds/sound-2555.wav",
      "fixtures/render/sounds/sound-2563.wav",
      "fixtures/render/sounds/sound-2662.wav",
      "fixtures/render/sounds/sound-2663.wav",
      "fixtures/render/sounds/sound-2664.wav",
      "fixtures/render/sounds/sound-2665.wav",
      "fixtures/render/sounds/sound-2666.wav",
      "fixtures/render/sounds/sound-2667.wav",
      "fixtures/render/sounds/sound-2668.wav",
      "fixtures/render/sounds/sound-2669.wav",
      "fixtures/render/sounds/sound-2670.wav",
      "fixtures/render/sounds/sound-2675.wav",
      "fixtures/render/sounds/sound-2676.wav",
      "fixtures/render/sounds/sound-2677.wav",
      "fixtures/render/sounds/sound-2678.wav",
      "fixtures/render/sounds/sound-2679.wav",
      "fixtures/render/sounds/sound-2680.wav",
      "fixtures/render/sounds/sound-2682.wav",
      "fixtures/render/sounds/sound-2684.wav",
      "fixtures/render/sounds/sound-2685.wav",
      "fixtures/render/sounds/sound-2686.wav",
      "fixtures/render/sounds/sound-2687.wav",
      "fixtures/render/sounds/sound-2688.wav",
      "fixtures/render/sounds/sound-2689.wav",
      "fixtures/render/sounds/sound-2690.wav",
      "fixtures/render/sounds/sound-2691.wav",
      "fixtures/render/sounds/sound-2693.wav",
      "fixtures/render/sounds/sound-2695.wav",
      "fixtures/render/sounds/sound-2714.wav",
      "fixtures/render/sounds/sound-2715.wav",
      "fixtures/render/sounds/sound-2720.wav",
      "fixtures/render/sounds/sound-2907.wav",
      "fixtures/render/sounds/sound-2910.wav",
      "fixtures/render/sounds/sound-2917.wav",
      "fixtures/render/sounds/sound-3825.wav",
      "fixtures/render/sounds/sound-3826.wav",
      "fixtures/render/sounds/sound-3846.wav",
      "fixtures/render/sounds/sound-3869.wav",
      "fixtures/render/sounds/sound-5027.wav",
      "fixtures/render/sounds/sound-6182.wav"
    ],
    acceptanceGate: "Runtime attack, spell, equip, special, bolt-proc, prayer, and Vengeance sounds resolve to exported cache WAVs and respect the separated sound-effect and area-sound volume controls.",
    notes: "The browser runtime plays short cache WAVs directly while preserving source sound ids in event metadata."
  },
  {
    id: "ui-sprites",
