...
for (const trackerLiteral of [
  ...
  "ClientUI.updateFrameConfig reads openosrs.enableOpacity and openosrs.opacityPercentage",
...
for (const configPanelLiteral of [
  ...
  "runeliteConfigBoolean(openOsrsValues.hidePlugins, false)",
  "runeliteConfigBoolean(openOsrsValues.hideExternalPlugins, false)",
  "runeliteConfigBoolean(openOsrsValues.hidePvmPlugins, false)",
  "runeliteConfigBoolean(openOsrsValues.hideSkillingPlugins, false)",
  "runeliteConfigBoolean(openOsrsValues.hidePvpPlugins, false)",
  "runeliteConfigBoolean(openOsrsValues.hideUtilityPlugins, false)",
